...
enum class CardBrand(
    ...
    @DrawableRes val errorIcon: Int =
        if (ThemeManager.currentTheme.isNotEmpty() && ThemeManager.currentTheme.contains("dark")) R.drawable.ic_card_icon_black else R.drawable.ic_card_icon_black,
    ...
    AmericanExpress(
        ...
        errorIcon = if (ThemeManager.currentTheme.isNotEmpty() && ThemeManager.currentTheme.contains("dark")) R.drawable.ic_card_icon_black else R.drawable.ic_card_icon_black,
        cvcLength = setOf(3, 4),
        defaultMaxLength = 15,
